...
<script type="text/javascript" src="{{ url('vendor/azmenu/scripts.js') }}"></script>
<script type="text/javascript" src="{{ url('vendor/azmenu/scripts2.js') }}"></script>
<script type="text/javascript" src="{{ url('vendor/azmenu/menu.js') }}"></script>
