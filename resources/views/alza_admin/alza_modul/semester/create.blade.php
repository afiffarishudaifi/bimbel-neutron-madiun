        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    ...
                    @endif
                    {!! Form::open(['route' => config('pathadmin.admin_prefix').'semesters.store', 'method' => 'POST', 'class' => 'form form-vertical','enctype' => 'multipart/form-data']) !!}
                    <div class="form-body">
                        <div class="row">
                            
                            <div class="col-12"><div class="form-group"><label>nama_semester</label><input name="nama_semester" class="form-control" type="text" value="{{ old('nama_semester') }}"></div></div><div class="col-12"><div class="form-group"><label>tahun</label><input name="tahun" class="form-control" type="text" value="{{ old('tahun') }}"></div></div><div class="col-12"><div class="form-group"><label>kode</label><select name="kode" class="form-control">
