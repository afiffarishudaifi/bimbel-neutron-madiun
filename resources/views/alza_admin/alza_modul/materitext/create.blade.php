        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    ...
                    @endif
                    {!! Form::open(['route' => config('pathadmin.admin_prefix') . 'materitexts.store', 'method' => 'POST', 'class' => 'form form-vertical', 'enctype' => 'multipart/form-data']) !!}
                    <div class="form-body">
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="form-group"><label>nama_materitext</label><input name="nama_materitext"
                                        class="form-control" type="text" value="{{ old('nama_materitext') }}"></div>
                            </div>
                            <div class="col-12">
                                <div class="form-group"><label>text</label>
                                    <textarea name="text" class="form-control" rows="10" id="body">{{ old('text') }}</textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group"><label>no_urut</label><input name="no_urut" class="form-control"
                                        type="number" value="{{ old('no_urut') }}"></div>
                            </div>
