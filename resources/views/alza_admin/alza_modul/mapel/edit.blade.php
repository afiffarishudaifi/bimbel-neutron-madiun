        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    ...
                    @endif
                    {!! Form::model($mapel, ['method' => 'PATCH', 'route' => [config('pathadmin.admin_prefix').'mapels.update', $mapel->id],'enctype' => 'multipart/form-data']) !!}
                    <div class="form-body">
                        <div class="row">
                            
                            <div class="col-12"><div class="form-group"><label>nama_mapel</label><input name="nama_mapel" class="form-control" type="text" value="{{$mapel->nama_mapel}}"></div></div><div class="col-12"><div class="form-group"><label>kode</label><input name="kode" class="form-control" type="text" value="{{$mapel->kode}}"></div></div>
