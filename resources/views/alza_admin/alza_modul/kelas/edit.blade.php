        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    ...
                    @endif
                    {!! Form::model($kelas, ['method' => 'PATCH', 'route' => [config('pathadmin.admin_prefix').'kelass.update', $kelas->id],'enctype' => 'multipart/form-data']) !!}
                    <div class="form-body">
                        <div class="row">
                            
                            <div class="col-12"><div class="form-group"><label>nama_kelas</label><input name="nama_kelas" class="form-control" type="text" value="{{$kelas->nama_kelas}}"></div></div>
