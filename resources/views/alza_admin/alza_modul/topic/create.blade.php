        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    ...
                    @endif
                    {!! Form::open(['route' => config('pathadmin.admin_prefix') . 'topics.store', 'method' => 'POST', 'class' => 'form form-vertical', 'enctype' => 'multipart/form-data']) !!}
                    <div class="form-body">
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="form-group"><label>title</label><input name="title" class="form-control"
                                        type="text" value="{{ old('title') }}"></div>
                            </div>
                            <div class="col-12">
                                <div class="form-group"><label>desc</label>
                                    <textarea name="desc" class="form-control" rows="10" id="body">{{ old('desc') }}</textarea>
                                </div>
                            </div>
